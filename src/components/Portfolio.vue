    ...
    <section>
        ...
        <div class="slider">
            ...
            <div class="slide-container-wrapper">
                <transition-group class="slide-container" tag="ul" name="slider-transition">
                   <li class="slide"
        ...
        <div class="slide-desc" :class="{animate: animate}"  @transitionend="animate = false">
...
.slide-desc.animate .slide-title, .slide-desc.animate .slide-text {
