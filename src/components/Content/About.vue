<template lang="pug">
    section#bottom
        ...
        .offset-wrapper
            Slider(:section-id='0', :nav-direction-type="'vertical-nav'")
        Portfolio
        .offset-wrapper
            .articles
                article
